...
<div class="col-md-12">    
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane active" id="tab_1">
                <div class="form-group">
                   ...
                   <div class="col-sm-4">
                    <input type="date" class="form-control" id="uraian" name="txttglpulang" disabled="disabled"  value="<?php echo $data['tgl_keluar'];?>" onkeypress="return hanyaAngka(event)" placeholder="Tgl kunjungan" required oninvalid="this.setCustomValidity('Tidak Boleh Kosong')" oninput="setCustomValidity('')" />
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control" name="txtrawatan" disabled="disabled" placeholder="Perkembangan Rawat Inap"><?php echo $data['rawatan'];?></textarea>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="cbicd" class="form-control select2" disabled="disabled"  style="width: 100%;">
                      <?php
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="cbcarapulang" class="form-control select2" disabled="disabled"  style="width: 100%;">
                      <?php
        ...
        <!-- /.col -->
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <input type="submit" name="btnedit" class="btn btn-primary  pull-right fa fa-send" value="Buka Ulang Pasien">
                    </div>
                  </div>
                </div>
              </div>
     ...
     <?php
          if (isset($_POST["btnedit"])){
            ...
            $edit = mysqli_query($konek,"UPDATE  tbl_kunjungan SET status='Masih di Rawat' WHERE kode='$id'");
            if ($edit) {  ?>
