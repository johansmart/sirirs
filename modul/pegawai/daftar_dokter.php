  ...
  <div class="box">
            <div class="box-header">
              <h3 class="box-title">NAMA-NAMA DOKTER</h3>
            </div>
              ...
              <!-- <div class="box-body table-responsive no-padding"> -->
               <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td align="right"> 
                    <a href="beranda.php?page=detail_jadwal&id=<?php echo base64_encode($data['kode']); ?>"><button  class="btn btn-primary fa fa-list"> VIEW</button></a>
