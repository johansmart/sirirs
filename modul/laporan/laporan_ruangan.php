...
<!-- <div class="well well-sm noprint">
 ...
 -->
              ...
              <div class="modal-body" id="cetak_report">
                ...
                <center><H3> LAPORAN RUANGAN RAWAT INAP DAN RAWAT JALAN <br>  DI RS MUJI RAHAYU </H3></center>
                ...
                $no = 1;
                  if(isset($_REQUEST['submit'])){
                   ...
                   $tgl1 = $_REQUEST['tgl1'];
                   $tgl2 = $_REQUEST['tgl2'];
                      $select = mysqli_query($konek, "SELECT * FROM tbl_ruangan");

                        }else {
                           $select = mysqli_query($konek,"SELECT * from tbl_ruangan  ORDER by keterangan asc");
                           }
