  <?php
  error_reporting(0); 
  $carikode = mysqli_query($konek, "select max(kode) from tbl_rujukan") or die (mysql_error());
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">MASTER RUJUKAN</h4>
              </div>
                              ...
                              if (isset($_POST["btnsimpan"])){
                                $txturaian =$_POST['txturaian'];
                                 $txtkode =$_POST['txtkode'];
                                  $simpan = mysqli_query($konek,"INSERT INTO tbl_rujukan (kode,uraian) VALUES ('$txtkode','$txturaian')");
                                if ($simpan){
                                  ?>
                                  <script type="text/javascript">
                                    document.location.href="beranda.php?page=rujukan";
                                  </script>
                                  <?php
                                }else{
                                 echo "<script>alert('Data Anda Gagal di simpan')</script>";
                                 echo "<meta http-equiv='refresh' content='0; url=?page=rujukan'>";
                                }
                                }
                                ?>
            ...
            <div class="box-header with-border">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <?php
                            $no =1;
                              $qry = mysqli_query($konek,"SELECT * FROM tbl_rujukan order by uraian asc");
                    ...
                    <tr>
                       ...
                       <td> <a href="beranda.php?page=edit_rujukan&id=<?php echo base64_encode($data['kode']); ?>" class="fa fa-edit">Edit</a></td>
                       <td> <a onClick="return confirm('Yakin Anda Menghapus ?')" href="beranda.php?page=rujukan&hapus=<?php echo $data['kode']; ?>" class="fa fa-eraser">Hapus</a></td>
                    </tr>
                  <?php } ?>
                  </tfoot>
              </table>
...
<?php
if (isset($_GET[hapus])){
  $qry=mysqli_query($konek,"delete from tbl_rujukan where kode='".$_GET["hapus"]."'");
  if ($qry){
